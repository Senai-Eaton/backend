...
namespace eaton.agir.webApi.Controllers
{
    ...
    public class EnderecoController: Controller
    {
        ...
        public EnderecoController(IBaseRepository<Endereco>enderecoRepository){
        ...
        [HttpPost]
        public IActionResult Cadastrar([FromBody]Endereco ende){
                try{
        ...
        [HttpPut("{id}")]
        public IActionResult Atualizar(int Id,[FromBody]Endereco ende){
            try{
